...
require([
  ...
  //const map = new Map({ layers: [layer,layer2] });
    ...
    //map.addMany([geojsonLayer1, geojsonLayer3]);
...
return  group_symbol
    ...
    function createGraphic(Graphicdata,hands_on){
       ...
       if(hands_on){
          ...
          // center_latitude = view.center.latitude;
          // center_latitude_str = center_latitude.toFixed(3)
          // center_longitude = view.center.longitude;
          // center_longitude_str = center_longitude.toFixed(3)
          //if (center_longitude_str != '121.617' && center_latitude_str != '25.052'){
          //       view.goTo({
          //           center: ['121.617', '25.052'], // Target location
          //           zoom: 18 // Zoom level
          //                 });
          // //} // if center_longitude_str
           //console.log(view.center);
           //center_latitude = view.center.latitude;
           //center_longitude = view.center.longitude;
...
window.onload = function(){
    ...
    var connection = new ReconnectingWebSocket('ws://140.109.171.96:8001/websocket?id=map_loc','GET', {debug: true, reconnectInterval: 3000});
     ...
     connection.onmessage = function(event) {
        ...
        if(newData.id == '280-data'){
          ...
          Object.keys(newData.data).forEach(function(k){
            ...
            createGraphic(newData.data[k],false);
                       })
        }else{
